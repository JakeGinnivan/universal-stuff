...
export const createServer = (config) => {
    const __PROD__ = config.nodeEnv === 'production' // eslint-disable-line no-underscore-dangle
    const __TEST__ = config.nodeEnv === 'test' // eslint-disable-line no-underscore-dangle
